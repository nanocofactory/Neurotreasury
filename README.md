# Conversion Tokens — Minimal Prototypes
...
- conversion as **composition of rotations / alignments** rather than price functions,
- a primitive for **convertive (nanoeconomic) efficiency** — the efficiency of transitions.

What they are:
- working computational diagrams,
- proofs-of-concept for choice-to-exchange computation,
- semantic anchors for further theoretical work.

What they are not:
- finished UIs or products,
- pricing or optimization models,
- commitments to stability, maintenance, or feature growth.
